...
<template>
  <div v-if="categories.length > 0" class="menu" :class="{ open: open }">
    ...
    <div class="menu__right">
      <NuxtLink :to="'/catalog/' + categories[activeIndex].slug">{{ categories[activeIndex].name }}</NuxtLink>
      <div class="menu__list">
        <div
          class="menu__list-item"
          v-for="(sub, i) in categories[activeIndex].children"
          :key="i"
        >
          <NuxtLink :to="'/catalog/' + sub.slug" >{{ sub.name }}</NuxtLink>
          <ul>
            <li v-for="(item, j) in sub.children" :key="j">
              <NuxtLink :to="'/catalog/' + item.slug">{{ item.name }}</NuxtLink>
            </li>
          </ul>
        </div>
      </div>
